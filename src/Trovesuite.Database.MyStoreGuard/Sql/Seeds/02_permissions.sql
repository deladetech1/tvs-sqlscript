...
('permission-msg-credit-score-settings', 'Mystoreguard Credit Score Settings', 'rt-credit-scores', 'Can change how customers are scored. Held separately from reading a score because re-weighting decides who gets credit.', CURRENT_DATE::TEXT, CURRENT_TIME::TEXT, CURRENT_TIMESTAMP),
('permission-msg-credit-score-adjust', 'Mystoreguard Credit Score Adjust', 'rt-credit-scores', 'Can override a customer''s score by hand. Separate again: it overrules the engine for one person.', CURRENT_DATE::TEXT, CURRENT_TIME::TEXT, CURRENT_TIMESTAMP),
('permission-msg-collection-reconcile', 'Mystoreguard Collection Reconcile', 'rt-collections', 'Can match money that arrived outside the till to a plan, and post it. Posting moves somebody''s balance, so it is not a read.', CURRENT_DATE::TEXT, CURRENT_TIME::TEXT, CURRENT_TIMESTAMP),
