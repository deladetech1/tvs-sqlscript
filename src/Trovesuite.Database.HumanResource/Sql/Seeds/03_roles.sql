...
-- App-level admin + per-module admin roles (MystoreGuard-style; triggers assign CRUD permissions)
...
('role-subscribed-app-hr-admin', 'system-tenant-id', 'HR Admin', 'Administrator of the Human Resources system', 'rt-subscribed-app-hr', true, true, CURRENT_DATE::TEXT, CURRENT_TIME::TEXT, CURRENT_TIMESTAMP),
