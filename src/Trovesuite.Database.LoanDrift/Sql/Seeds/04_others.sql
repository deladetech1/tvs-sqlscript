...
('system-tenant-id', 'role-subscribed-app-loandrift-admin', 'permission-loandrift-expenses-create'),
('system-tenant-id', 'role-subscribed-app-loandrift-admin', 'permission-loandrift-expenses-get'),
('system-tenant-id', 'role-subscribed-app-loandrift-admin', 'permission-loandrift-expenses-update'),
('system-tenant-id', 'role-subscribed-app-loandrift-admin', 'permission-loandrift-expenses-delete'),
('system-tenant-id', 'role-subscribed-app-loandrift-admin', 'permission-loandrift-expenses-get-statistics'),
