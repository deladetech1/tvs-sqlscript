...
namespace Trovesuite.Database.LoanDrift.Migrations
{
    ...
    [Migration("20260829150515_AddCrbRegulatoryProfilesAndIdentifications")]
    partial class AddCrbRegulatoryProfilesAndIdentifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.BranchProfile", b =>
                {
                    b.Property<string>("TenantId")
                        .HasColumnType("text")
                        .HasColumnName("tenant_id");
                    ...
                    b.Property<string>("BogBranchCode")
                        .HasColumnType("text")
                        .HasColumnName("bog_branch_code");
                    ...
                    b.HasKey("TenantId", "OrgId", "BusId", "LocId", "Id")
                        .HasName("pk_ld_branch_profile");

                    b.HasIndex("BusId", "TenantId")
                        .HasDatabaseName("ix_ld_branch_profile_bus_id_tenant_id");

                    b.HasIndex("CreatedBy", "TenantId")
                        .HasDatabaseName("ix_ld_branch_profile_created_by_tenant_id");

                    b.HasIndex("DeletedBy", "TenantId")
                        .HasDatabaseName("ix_ld_branch_profile_deleted_by_tenant_id");

                    b.HasIndex("LocId", "TenantId")
                        .HasDatabaseName("ix_ld_branch_profile_loc_id_tenant_id");

                    b.HasIndex("OrgId", "TenantId")
                        .HasDatabaseName("ix_ld_branch_profile_org_id_tenant_id");

                    b.HasIndex("UpdatedBy", "TenantId")
                        .HasDatabaseName("ix_ld_branch_profile_updated_by_tenant_id");

                    b.HasIndex("TenantId", "OrgId", "BusId", "BranchCode")
                        .IsUnique()
                        .HasDatabaseName("ix_ld_branch_profile_tenant_id_org_id_bus_id_branch_code");

                    b.HasIndex("TenantId", "OrgId", "BusId", "LocId")
                        .IsUnique()
                        .HasDatabaseName("ix_ld_branch_profile_tenant_id_org_id_bus_id_loc_id");

                    b.ToTable("ld_branch_profile", "loandrift", t =>
                        {
                            t.HasCheckConstraint("ck_ld_branch_profile_delete_status", "delete_status IN ('PENDING','DELETED','NOT_DELETED')");
                        });
                });
                    ...
                    b.ToTable("ld_clients", "loandrift", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_ld_clients_id_type", "id_type IN ('GHANA_CARD','VOTER_ID','DRIVERS_LICENSE','PASSPORT','SSNIT','EZWICH','TIN','NHIS','OTHER',NULL)");

                            t.HasCheckConstraint("ck_ld_clients_marital_status", "marital_status IN ('SINGLE','MARRIED','DIVORCED','WIDOWED',NULL)");

                            t.HasCheckConstraint("ck_ld_clients_title", "title IN ('MR','MRS','MISS','MS','DR','MADAM',NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.ClientIdentification", b =>
                {
                    b.Property<string>("TenantId")
                        .HasColumnType("text")
                        .HasColumnName("tenant_id");
                    ...
                    b.Property<string>("OtherIdLabel")
                        .HasColumnType("text")
                    ...
                    b.HasKey("TenantId", "OrgId", "BusId", "LocId", "Id")
                        .HasName("pk_ld_client_identifications");

                    b.HasIndex("BusId", "TenantId")
                        .HasDatabaseName("ix_ld_client_identifications_bus_id_tenant_id");

                    b.HasIndex("CreatedBy", "TenantId")
                        .HasDatabaseName("ix_ld_client_identifications_created_by_tenant_id");

                    b.HasIndex("DeletedBy", "TenantId")
                        .HasDatabaseName("ix_ld_client_identifications_deleted_by_tenant_id");

                    b.HasIndex("LocId", "TenantId")
                        .HasDatabaseName("ix_ld_client_identifications_loc_id_tenant_id");

                    b.HasIndex("OrgId", "TenantId")
                        .HasDatabaseName("ix_ld_client_identifications_org_id_tenant_id");

                    b.HasIndex("UpdatedBy", "TenantId")
                        .HasDatabaseName("ix_ld_client_identifications_updated_by_tenant_id");

                    b.HasIndex("TenantId", "OrgId", "BusId", "LocId", "ClientId")
                        .IsUnique()
                        .HasDatabaseName("ux_ld_client_identifications_primary")
                        .HasFilter("is_primary");

                    b.HasIndex("TenantId", "OrgId", "BusId", "LocId", "ClientId", "IdType")
                        .IsUnique()
                        .HasDatabaseName("ix_ld_client_identifications_tenant_id_org_id_bus_id_loc_id_cl");

                    b.ToTable("ld_client_identifications", "loandrift", t =>
                        {
                            t.HasCheckConstraint("ck_ld_client_identifications_delete_status", "delete_status IN ('PENDING','DELETED','NOT_DELETED')");

                            t.HasCheckConstraint("ck_ld_client_identifications_id_type", "id_type IN ('GHANA_CARD','VOTER_ID','DRIVERS_LICENSE','PASSPORT','SSNIT','EZWICH','TIN','NHIS','OTHER')");
                        });
                });

            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.CompanyProfile", b =>
                {
                    b.Property<string>("TenantId")
                        .HasColumnType("text")
                        .HasColumnName("tenant_id");
                    ...
                    b.Property<string>("BogInstitutionCode")
                        .HasColumnType("text")
                        .HasColumnName("bog_institution_code");

                    b.Property<string>("BogLicenceNumber")
                        .HasColumnType("text")
                        .HasColumnName("bog_licence_number");
                    ...
                    b.HasKey("TenantId", "OrgId", "BusId", "Id")
                        .HasName("pk_ld_company_profile");

                    b.HasIndex("BusId", "TenantId")
                        .HasDatabaseName("ix_ld_company_profile_bus_id_tenant_id");

                    b.HasIndex("CreatedBy", "TenantId")
                        .HasDatabaseName("ix_ld_company_profile_created_by_tenant_id");

                    b.HasIndex("DeletedBy", "TenantId")
                        .HasDatabaseName("ix_ld_company_profile_deleted_by_tenant_id");

                    b.HasIndex("OrgId", "TenantId")
                        .HasDatabaseName("ix_ld_company_profile_org_id_tenant_id");

                    b.HasIndex("UpdatedBy", "TenantId")
                        .HasDatabaseName("ix_ld_company_profile_updated_by_tenant_id");

                    b.HasIndex("TenantId", "OrgId", "BusId")
                        .IsUnique()
                        .HasDatabaseName("ix_ld_company_profile_tenant_id_org_id_bus_id");

                    b.ToTable("ld_company_profile", "loandrift", t =>
                        {
                            t.HasCheckConstraint("ck_ld_company_profile_delete_status", "delete_status IN ('PENDING','DELETED','NOT_DELETED')");

                            t.HasCheckConstraint("ck_ld_company_profile_institution_type", "institution_type IN ('MICROFINANCE','SAVINGS_AND_LOANS','RURAL_BANK','FINANCE_HOUSE','CREDIT_UNION','LEASING','MONEY_LENDER','OTHER',NULL)");
                        });
                });
                    ...
                    b.ToTable("ld_guarantors", "loandrift", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_ld_guarantors_id_type", "id_type IN ('GHANA_CARD','VOTER_ID','DRIVERS_LICENSE','PASSPORT','SSNIT','EZWICH','TIN','NHIS','OTHER',NULL)");
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.GuarantorIdentification", b =>
                {
                    b.Property<string>("TenantId")
                        .HasColumnType("text")
                        .HasColumnName("tenant_id");
                    ...
                    b.HasKey("TenantId", "OrgId", "BusId", "LocId", "Id")
                        .HasName("pk_ld_guarantor_identifications");

                    b.HasIndex("BusId", "TenantId")
                        .HasDatabaseName("ix_ld_guarantor_identifications_bus_id_tenant_id");

                    b.HasIndex("CreatedBy", "TenantId")
                        .HasDatabaseName("ix_ld_guarantor_identifications_created_by_tenant_id");

                    b.HasIndex("DeletedBy", "TenantId")
                        .HasDatabaseName("ix_ld_guarantor_identifications_deleted_by_tenant_id");

                    b.HasIndex("LocId", "TenantId")
                        .HasDatabaseName("ix_ld_guarantor_identifications_loc_id_tenant_id");

                    b.HasIndex("OrgId", "TenantId")
                        .HasDatabaseName("ix_ld_guarantor_identifications_org_id_tenant_id");

                    b.HasIndex("UpdatedBy", "TenantId")
                        .HasDatabaseName("ix_ld_guarantor_identifications_updated_by_tenant_id");

                    b.HasIndex("TenantId", "OrgId", "BusId", "LocId", "GuarantorId")
                        .IsUnique()
                        .HasDatabaseName("ux_ld_guarantor_identifications_primary")
                        .HasFilter("is_primary");

                    b.HasIndex("TenantId", "OrgId", "BusId", "LocId", "GuarantorId", "IdType")
                        .IsUnique()
                        .HasDatabaseName("ix_ld_guarantor_identifications_tenant_id_org_id_bus_id_loc_id");

                    b.ToTable("ld_guarantor_identifications", "loandrift", t =>
                        {
                            t.HasCheckConstraint("ck_ld_guarantor_identifications_delete_status", "delete_status IN ('PENDING','DELETED','NOT_DELETED')");

                            t.HasCheckConstraint("ck_ld_guarantor_identifications_id_type", "id_type IN ('GHANA_CARD','VOTER_ID','DRIVERS_LICENSE','PASSPORT','SSNIT','EZWICH','TIN','NHIS','OTHER')");
                        });
                });
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.LoanDetail", b =>
                {
                    ...
                    b.HasIndex("LoanReference")
                        .IsUnique()
                        .HasDatabaseName("ix_ld_loan_details_loan_reference");
                    ...
                    b.ToTable("ld_repayments", "loandrift", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_ld_repayments_payment_method", "payment_method IN ('CASH','CHEQUE','MOMO','BANK_TRANSFER','CARD','OTHERS',NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.BranchProfile", b =>
                {
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Tenant", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_ld_branch_profile_cp_tenants_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Business", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_ld_branch_profile_cp_businesses_bus_id_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_branch_profile_cp_users_created_by_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("DeletedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_branch_profile_cp_users_deleted_by_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Location", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_branch_profile_cp_locations_loc_id_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Organization", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_branch_profile_cp_organizations_org_id_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UpdatedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_branch_profile_cp_users_updated_by_tenant_id");
                });
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.ClientIdentification", b =>
                {
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ld_client_identifications_cp_tenants_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Business", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_client_identifications_cp_businesses_bus_id_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_client_identifications_cp_users_created_by_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("DeletedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_client_identifications_cp_users_deleted_by_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Location", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_client_identifications_cp_locations_loc_id_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Organization", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_client_identifications_cp_organizations_org_id_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UpdatedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_client_identifications_cp_users_updated_by_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.LoanDrift.Entities.Client", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ld_client_identifications_ld_clients_tenant_id_org_id_bus_i");
                });
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.CompanyProfile", b =>
                {
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ld_company_profile_cp_tenants_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Business", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_company_profile_cp_businesses_bus_id_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_company_profile_cp_users_created_by_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("DeletedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_company_profile_cp_users_deleted_by_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Organization", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_company_profile_cp_organizations_org_id_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UpdatedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_company_profile_cp_users_updated_by_tenant_id");
                });
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.GuarantorIdentification", b =>
                {
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ld_guarantor_identifications_cp_tenants_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Business", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_guarantor_identifications_cp_businesses_bus_id_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_guarantor_identifications_cp_users_created_by_tenant_id");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("DeletedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_guarantor_identifications_cp_users_deleted_by_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Location", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_guarantor_identifications_cp_locations_loc_id_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Organization", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ld_guarantor_identifications_cp_organizations_org_id_tenant");

                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UpdatedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_guarantor_identifications_cp_users_updated_by_tenant_id");

                    b.HasOne("Trovesuite.Database.LoanDrift.Entities.Guarantor", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "OrgId", "BusId", "LocId", "GuarantorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ld_guarantor_identifications_ld_guarantors_tenant_id_org_id");
                });
