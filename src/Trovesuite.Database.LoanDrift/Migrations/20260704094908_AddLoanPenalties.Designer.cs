...
namespace Trovesuite.Database.LoanDrift.Migrations
{
    ...
    [Migration("20260704094908_AddLoanPenalties")]
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.LoanDetail", b =>
                {
                    ...
                    b.Property<decimal>("PenaltiesOutstanding")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,6)")
                        .HasDefaultValue(0m)
                        .HasColumnName("penalties_outstanding");
                    ...
                    b.Property<decimal>("TotalPenaltiesApplied")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,6)")
                        .HasDefaultValue(0m)
                        .HasColumnName("total_penalties_applied");

                    b.Property<decimal>("TotalPenaltiesWaived")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,6)")
                        .HasDefaultValue(0m)
                        .HasColumnName("total_penalties_waived");
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.Penalty", b =>
                {
                    ...
                    b.Property<string>("AppliedSettingsVersion")
                        .HasColumnType("text")
                        .HasColumnName("applied_settings_version");
                    ...
                    b.HasIndex("CurrencyId", "TenantId")
                        .HasDatabaseName("ix_ld_penalties_currency_id_tenant_id");
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.PenaltyWaiver", b =>
                {
                    ...
                    b.HasIndex("ApprovedBy", "TenantId")
                        .HasDatabaseName("ix_ld_penalty_waivers_approved_by_tenant_id");
                    ...
                    b.HasIndex("RequestedBy", "TenantId")
                        .HasDatabaseName("ix_ld_penalty_waivers_requested_by_tenant_id");
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.Repayment", b =>
                {
                    ...
                    b.Property<decimal>("PenaltiesAfter")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,6)")
                        .HasDefaultValue(0m)
                        .HasColumnName("penalties_after");

                    b.Property<decimal>("PenaltiesBefore")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(20,6)")
                        .HasDefaultValue(0m)
                        .HasColumnName("penalties_before");
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.Penalty", b =>
                {
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.Currency", null)
                        ...
                        .HasForeignKey("CurrencyId", "TenantId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_ld_penalties_cp_currencies_currency_id_tenant_id");
            ...
            modelBuilder.Entity("Trovesuite.Database.LoanDrift.Entities.PenaltyWaiver", b =>
                {
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        ...
                        .HasForeignKey("ApprovedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_penalty_waivers_cp_users_approved_by_tenant_id");
                    ...
                    b.HasOne("Trovesuite.Database.CorePlatform.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("RequestedBy", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ld_penalty_waivers_cp_users_requested_by_tenant_id");
