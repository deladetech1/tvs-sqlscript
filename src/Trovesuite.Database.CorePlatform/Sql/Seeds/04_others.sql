...
('app-hr', 'HR', 'Human Resource', 'Attendance Tracking', 'Leave Management', 'Payroll Processing', 'Performance Reviews', 'Complete HR management system for employee lifecycle, attendance, payroll, and performance tracking', CURRENT_DATE::TEXT, CURRENT_TIME::TEXT, CURRENT_TIMESTAMP, 'live', true),
...
('tier-cfg-hr-basic',       'app-hr',           'shared-subscription-basic',      5,    80.00, 12.0, CURRENT_DATE::TEXT, CURRENT_TIME::TEXT, CURRENT_TIMESTAMP),
